...
📥 Принимаю любые сообщения:
— текст, голосовые сообщения, фото/скриншоты

🗂 Сохраняю и классифицирую:
— задачи, идеи, мысли, заметки, напоминания
— всё автоматически попадает в Notion и Supabase

⏰ Напоминания:
— разовые: "напомни через 2 часа позвонить Диме"
— повторяющиеся: "каждый понедельник в 9 напоминай про отчёт"

📋 Управление задачами:
— /задачи — список всего открытого
— "сделал" или "сделал 5" — закрыть задачу
— /done 5 — то же самое командой

🔍 Поиск и аналитика:
— /поиск слово — найти записи
— /стат — сколько всего записей, задач, идей
— /экспорт — все задачи текстом

📊 Дайджесты:
— /итоги — сводка за сегодня и неделю
— каждое утро в 9:00 — автодайджест
— каждое воскресенье в 20:00 — итоги недели

💬 Общение:
— можешь просто спросить что-то или поговорить
